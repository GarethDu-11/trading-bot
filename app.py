...
def get_support_resistance(coin, timeframe="4H", limit=100):
    try:
        ...
        print(f"Lỗi khi lấy dữ liệu nến cho {coin}: {e}")
        return None, None, None, None, None
...
def get_current_price(coin):
    try:
        ...
        print(f"Lỗi khi lấy giá hiện tại cho {coin}: {e}")
        return None
...
# Chạy phân tích ban đầu và khởi động lịch trình khi ứng dụng khởi động
...
def startup():
    ...
    schedule_thread.daemon = True  # Đảm bảo thread dừng khi ứng dụng dừng
